                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card mb-4 mb-xl-0">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <button class="btn btn-primary" ><a href="accountmanager?do=listAccountEmployee" style="color: white; text-decoration: none;">Back to Account Manager</a></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-8">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header"><a href="accountmanager?do=listAccountEmployee">Account Employee </a>/ Update Account Employee</div>
                                            <c:if test="${mess != null}"> 
                                                <br>
                                            ...
                                            <div class="card-body">
                                                <form action="accountmanager?do=updateEmployee" method="post">
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input maxlength="50" maxlength="50" name="displayname" class="form-control"  type="text" placeholder="Enter your Display Name..." value="${l.displayname}">
                                                        </div>
                                                    </div>
                                                    <!-- Form Row        -->
                                                    <div class="row gx-3 mb-3">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${l.gender ==1}">
                                                                        <div class="form-check form-check-inline">
                                                                            ...
                                                                            <label class="form-check-label" for="inlineRadio1" style="color: black;    font-size: 64%">Male</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="0">
                                                                            <label class="form-check-label" for="inlineRadio2" style="color: black;    font-size: 64%">Female</label>
                                                                        </div>
                                                                    </c:when><c:otherwise>
                                                                        <div class="form-check form-check-inline">
