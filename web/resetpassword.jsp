                                        ...
                                        <div class="login-form-container">
                                            <div class="login-register-form">
                                                <c:if test="${mess != null}">${mess}</c:if>
                                                    ...
                                                    <input maxlength="6" type="number" name="password" placeholder="Your Code" >
                                                    <input maxlength="50" type="password" name="newpassword" placeholder="New Password" >
                                                    <input maxlength="50" type="password" name="confirmpassword" placeholder="Confirm Password" >
